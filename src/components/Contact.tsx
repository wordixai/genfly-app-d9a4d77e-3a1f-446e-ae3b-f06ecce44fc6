      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            We'd love to see you! Stop by for a coffee, a chat, or just to enjoy the atmosphere.
          </p>
        </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <MapPin className="h-5 w-5 text-amber-800 mr-3 mt-0.5" />
                  <div>
                ...
                <div className="flex items-start">
                  <Phone className="h-5 w-5 text-amber-800 mr-3 mt-0.5" />
                  <div>
                ...
                <div className="flex items-start">
                  <Mail className="h-5 w-5 text-amber-800 mr-3 mt-0.5" />
                  <div>
                    <p className="font-medium">Email</p>
                    <p className="text-gray-600">hello@cafearoma.example</p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <Clock className="h-5 w-5 text-amber-800 mr-3 mt-0.5" />
                  <div>
